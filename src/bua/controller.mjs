import BuaDetails from "./model.mjs";

//  GET BUA DOCUMENT

export const getBuaDocument = async (req, res, next) => {
  try {
...
export const createBuaDetails = async (req, res, next) => {
  try {
...
// UPDATE BUA DOCUMENT
export const updateBuaDetails = async (req, res, next) => {
  try {
    const { name, status } = req.body;
